...
locally = Deeloped the App on react and set up the work environment accordingly.
b. Discussion of technologies used - Make a list of the
technologies you used including frameworks and libraries.
= React and its libraries was primarily used for this project 

3. A section describing the requirements and how you met them.
= requirements are adding items to shopping cart, delete and summ the total and tried and worked on react components to accomplish.
